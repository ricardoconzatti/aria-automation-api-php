...
$apiUrl = '/iaas/api/network-profiles?$orderby=name%20asc'; // API URL
...
<head>
	...
	<title>Aria Automation - Network Profile</title>
...
<body>
    ...
    <div class="minimal-table">
		<div class="table-header-main">
			NETWORK PROFILE: <?php echo $total?>
        </div>
        <div class="table-row-title">
            <div class="table-cell-title">NAME</div>
			<div class="table-cell-title">TAGS</div>
			<div class="table-cell-title">ISOLATION TYPE</div>
		...
		<div class="table-row">
			...
			<div class="table-cell"><?php echo $data['content'][$i]['isolationType'];?></div>
