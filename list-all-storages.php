...
for ($ii = 0; $ii < $total; $ii++) {
	...
	switch ($data['content'][$ii]['type']) {
		case "VMFS":
			...
			break;
		case "StoragePod":
			$clusterDatastore = $clusterDatastore + 1;
			break;
	}
}
curl_close($ch);
...
<head>
    ...
    <title>Aria Automation - vSphere Disks</title>
...
<body>
    ...
    <div class="minimal-table">
        <div class="table-header-main">
            VSPHERE DISKS: <?php echo $total;?>
			<p class="table-header-sub">Datastore: <?php echo $datastore;?> | StoragePod (Datastore Cluster): <?php echo $clusterDatastore;?></p>
        </div>
        <div class="table-row-title">
            <div class="table-cell-title">NAME</div>
            <div class="table-cell-title">TYPE</div>
            <div class="table-cell-title">FREE SPACE</div>
		...
		<div class="table-row">
			...
			<div class="table-cell"><?php echo $data['content'][$i]['type'];?></div>
			<div class="table-cell"><?php echo $data['content'][$i]['freeSizeGB'] . ' GB';?></div>
